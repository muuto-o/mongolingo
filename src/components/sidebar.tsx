      ...
      <div className="h-full">
        <aside className="w-full bg-white p-6 h-full border-r border-gray-300 shadow-lg flex flex-col justify-between">
          ...
          <nav className="space-y-6">
            <div className="flex items-center text-blue-600 hover:text-gray-800 transition-colors duration-200 cursor-pointer border-2"
            onClick={()=>{navigate('/')}}>
              <i className="fas fa-home text-yellow-500 mr-3"></i>
              <span className="font-semibold">ХИЧЭЭЛ</span>
            </div>
            <div className="flex items-center text-blue-600 hover:text-gray-800 transition-colors duration-200 cursor-pointer"
