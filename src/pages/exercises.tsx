...
export default function Exercise() {
  ...
  //   setIsAnswerCorrect(null);
  //   if (count + 1 < incorrectQuestions.length) {
  //     setCount((prev) => prev + 1);
  //   } else {
  //     navigate(-1);
  //   }
  ...
  return (
    <div className="w-full h-screen bg-gray-50 flex flex-col items-center p-4">
      ...
      <Card className="w-full max-w-2xl bg-white shadow-md rounded-lg p-6 mb-6 border border-gray-200">
        <div className="text-lg font-semibold mb-4 text-gray-700">
          {isReviewMode
            ...
            : `Question ${count + 1} of ${exercises.unit_one.length}`}
        </div>
