...
export default function HomePage() {
  ...
  return (
    <div className="p-4 w-full h-full bg-gray-100 flex-col align-middle justify-center">
      ...
      {/* SECTION 1 */}
      <div className="bg-white p-4 rounded-lg mb-4 shadow-lg border-2 border-gray-300 w-10/12 flex justify-between">
        <div>
          ...
          <button className="bg-blue-600 text-white font-bold py-2 px-4 rounded-lg mt-4"
          onClick={()=> navigate('/lesson')}>Эхлүүлэх</button>
        </div>
